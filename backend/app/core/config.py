...
class Settings(BaseSettings):
    ...
    data_service_latest_version: str = Field(default="", alias="DATA_SERVICE_LATEST_VERSION")
    data_service_auto_update_enabled: bool = Field(
        default=False,
        alias="DATA_SERVICE_AUTO_UPDATE_ENABLED",
    )
